...
name=iqiyi.keys()
for x in name:
    url="http://cache.video.ptqy.gitv.tv/liven/"+iqiyi[x]+"?lp=&src=04022001010000000000&pf=9&m=1583&qyid=tv_0291415626b010b5342b13bd743ee69b_1502353950858"
    ...
    with open('iqiyi.htm', 'w', encoding="utf-8") as f: f.write(x + ":" + playurl + "\n")