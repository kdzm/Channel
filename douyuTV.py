...
name=room.keys()
datas=json.dumps({"v": "220120190402","did":"b222fadcd86d2e4cd417bcd700021501","tt": "1557044070","sign":"4b395839bfd5baf6a044943f267d6b9d","cdn": "","rate:":" 0","ver":"Douyu_219042975","iar":"1","ive": "0"})
for x in  name:
    url = "http://www.douyu.com/lapi/live/getH5Play/"+room[x]
    r=posturl(url,datas,headers=headers)
    print(r)