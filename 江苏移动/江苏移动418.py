...
#print(url)
#print(names)
with open('江苏移动418.dpl', 'w', encoding="utf-8") as f: f.write('')
with open('江苏移动418.dpl', 'a', encoding="utf-8") as f: f.write('DAUMPLAYLIST\n'+'playname=\n'+'topindex=27\n'+'saveplaypos=0'+'\n')
for u in url:
    j=url.index(u)
    (x,y)=lists(names[j],u)
    with open('江苏移动418.dpl', 'a+', encoding="utf-8") as f: f.write(str(j+1)+x + "\n"+str(j+1)+y+"\n"+str(j+1)+'*played*0\n')
file.close()
